...
<div class="container">
    ...
    <div class="row mt-3 d-flex justify-content-center">
        <div class="col-6">
            <form action="<?= URLROOT; ?>/sneaker/update/<?= $data['sneaker']->Id; ?>" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="gewicht" type="text" class="form-control <?= isset($data['errors']['gewicht']) ? 'is-invalid' : ''; ?>" id="gewicht" value="<?= $_POST['gewicht'] ?? $data['sneaker']->Gewicht; ?>">
